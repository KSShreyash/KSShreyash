...
I'm a software developer and student who likes systems you can see all the way down. Some
days that means a React front end that feels alive; other days it means writing an LSTM's
backward pass by hand in C++ because a framework was hiding the interesting part.
...
struct Wizard {
    ...
    std::vector<std::string> currently_brewing = {
        "AI agents that actually finish the task",
        "C++ deep learning, no frameworks",
        "DSA, on a timer"
    };
};
```
...
<tr><td><b>Illusions</b><br/><sub>frontend</sub></td><td>
...
<tr><td><b>Enchantments</b><br/><sub>backend &amp; data</sub></td><td>
...
<p align="center"><i>Mischief managed.</i></p>
